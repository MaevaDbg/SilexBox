...
--
-- Client: localhost
-- Généré le: Mar 17 Mars 2015 à 11:53
...
CREATE TABLE IF NOT EXISTS `article` (
  ...
  `lien_youtube` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
